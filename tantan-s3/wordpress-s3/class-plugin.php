...
class TanTanWordPressS3Plugin extends TanTanWordPressS3PluginPublic {
    ...
    function TanTanWordPressS3Plugin() {
        ...
        if (!isset($this->options['hideAmazonS3UploadTab']) or !$this->options['hideAmazonS3UploadTab']) {
        ...
        if (isset($_GET['tantanActivate']) and $_GET['tantanActivate'] == 'wordpress-s3') {
    ...
    function settings() {
        add_options_page('Amazon S3', 'Amazon S3', 'activate_plugins', __FILE__, array(&$this, 'admin'));
        $this->version_check();
    }
    function addhooks() {
        parent::addhooks();
    ...
    */
    ...
    function upload_tabs_scripts() {
        ...
        $accessDomain = (isset($this->options['virtual-host']) and $this->options['virtual-host']) ? $this->options['bucket'] : $this->options['bucket'].'.s3.amazonaws.com';
    ...
    function tab() {
        ...
        $prefix = (isset($_GET['prefix']) and $_GET['prefix']) ? $_GET['prefix'] : '';
